...
(function($PS) {
  ...
  var spawning = function (spawn) {
      return Screeps_FFI.toMaybe(Screeps_FFI.unsafeField("spawning")(spawn));
  };                                             
...
(function($PS) {
  ...
  var LDHarvesterRole = (function () {
      function LDHarvesterRole() {

      };
      LDHarvesterRole.value = new LDHarvesterRole();
      return LDHarvesterRole;
  })();
  ...
  var LDHarvesterMemory = (function () {
      function LDHarvesterMemory(value0) {
          this.value0 = value0;
      };
      LDHarvesterMemory.create = function (value0) {
          return new LDHarvesterMemory(value0);
      };
      return LDHarvesterMemory;
  })();
  ...
  var LDHarvester = (function () {
      function LDHarvester(value0) {
          this.value0 = value0;
      };
      LDHarvester.create = function (value0) {
          return new LDHarvester(value0);
      };
      return LDHarvester;
  })();
  var encodeRole = new Data_Argonaut_Encode_Class.EncodeJson(function (v) {
      ...
      if (v instanceof LDHarvesterRole) {
          return Data_Argonaut_Core.fromString("\"LDHarvester\"");
      };
      throw new Error("Failed pattern match at CreepRoles (line 37, column 1 - line 41, column 65): " + [ v.constructor.name ]);
  });
  var encodeCreepMemory = new Data_Argonaut_Encode_Class.EncodeJson(function (v) {
      ...
      if (v instanceof LDHarvesterMemory) {
          return Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonCons(encodeRole)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
              return "targetRoom";
          }))())(new Data_Symbol.IsSymbol(function () {
              return "role";
          }))())(new Data_Symbol.IsSymbol(function () {
      ...
      throw new Error("Failed pattern match at CreepRoles (line 62, column 1 - line 66, column 54): " + [ v.constructor.name ]);
  });
          ...
          var v2 = function (v3) {
              var v4 = function (v5) {
                  var v6 = function (v7) {
                      ...
                      throw new Error("Failed pattern match at CreepRoles (line 43, column 1 - line 49, column 82): " + [ json.constructor.name ]);
                  };
                  var $31 = Data_Argonaut_Core.stringify(json);
                  if ($31 === "\"LDHarvester\"") {
                      return new Data_Either.Right(LDHarvesterRole.value);
                  };
                  return v6(true);
              };
              var $33 = Data_Argonaut_Core.stringify(json);
              if ($33 === "\"Upgrader\"") {
                  return new Data_Either.Right(UpgraderRole.value);
              };
              return v4(true);
          };
          var $35 = Data_Argonaut_Core.stringify(json);
          if ($35 === "\"Builder\"") {
              return new Data_Either.Right(BuilderRole.value);
          };
          return v2(true);
      };
      var $37 = Data_Argonaut_Core.stringify(json);
      if ($37 === "\"Harvester\"") {
  ...
  var classifyCreep = function (creep) {
      return function __do() {
          ...
          if (v instanceof Data_Either.Right && v.value0 instanceof LDHarvesterRole) {
              var v1 = Screeps_Creep.getMemory(Data_Argonaut_Decode_Class.decodeJsonString)(creep)("targetRoom")();
              var v2 = Screeps_Creep.getMemory(Data_Argonaut_Decode_Class.decodeJsonString)(creep)("home")();
              ...
              if (v1 instanceof Data_Either.Right) {
                  ...
                  if (v2 instanceof Data_Either.Right) {
                      return Data_Either.Right.create(new LDHarvester({
                          creep: creep,
                          mem: {
                              role: LDHarvesterRole.value,
                              targetRoom: v1.value0,
                              home: v2.value0
                          }
                      }));
                  };
                  throw new Error("Failed pattern match at CreepRoles (line 99, column 11 - line 103, column 97): " + [ v2.constructor.name ]);
              };
              throw new Error("Failed pattern match at CreepRoles (line 95, column 7 - line 103, column 97): " + [ v1.constructor.name ]);
          };
          if (v instanceof Data_Either.Left) {
              return Data_Either.Left.create(v.value0);
          };
          throw new Error("Failed pattern match at CreepRoles (line 80, column 3 - line 105, column 41): " + [ v.constructor.name ]);
      };
  };
  exports["HarvesterRole"] = HarvesterRole;
  exports["BuilderRole"] = BuilderRole;
  exports["UpgraderRole"] = UpgraderRole;
  exports["LDHarvesterRole"] = LDHarvesterRole;
  exports["HarvesterMemory"] = HarvesterMemory;
  exports["BuilderMemory"] = BuilderMemory;
  exports["UpgraderMemory"] = UpgraderMemory;
  exports["LDHarvesterMemory"] = LDHarvesterMemory;
  exports["Harvester"] = Harvester;
  exports["Builder"] = Builder;
  exports["Upgrader"] = Upgrader;
  exports["LDHarvester"] = LDHarvester;
...
(function($PS) {
  ...
  var $foreign = $PS["Screeps.Room"];
  var Data_Either = $PS["Data.Either"];
  var Screeps_FFI = $PS["Screeps.FFI"];                    
  var RoomName = (function () {
      function RoomName(value0) {
          this.value0 = value0;
      };
      RoomName.create = function (value0) {
          return new RoomName(value0);
      };
      return RoomName;
  })();
  var RoomObj = (function () {
      function RoomObj(value0) {
          this.value0 = value0;
      };
      RoomObj.create = function (value0) {
          return new RoomObj(value0);
      };
      return RoomObj;
  })();
  var name = Screeps_FFI.unsafeField("name");       
  var findExitTo = function (room) {
      return function (v) {
          if (v instanceof RoomName) {
              return $foreign.findExitToImpl(room)(v.value0)(Data_Either.Left.create)(Data_Either.Right.create);
          };
          if (v instanceof RoomObj) {
              return $foreign.findExitToImpl(room)(v.value0)(Data_Either.Left.create)(Data_Either.Right.create);
          };
          throw new Error("Failed pattern match at Screeps.Room (line 113, column 1 - line 113, column 82): " + [ room.constructor.name, v.constructor.name ]);
      };
  };
...
(function($PS) {
  ...
  var Screeps_Spawn = $PS["Screeps.Spawn"];
  var Screeps_Types = $PS["Screeps.Types"];
  var createLDHarvesterForAdjacentRoom = function (spawn) {
      return function (energy) {
        
          // targetRoom = exitInfo."5"
  var workParts = [ Screeps_Constants.part_work, Screeps_Constants.part_work ];
          var numberOtherParts = Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(energy - 200 | 0)(100);
          var moveParts = Data_Functor.map(Data_Functor.functorArray)(function (n) {
              return Screeps_Constants.part_move;
          })(Data_Array.range(0)(numberOtherParts - 1 | 0));
          var carryParts = Data_Functor.map(Data_Functor.functorArray)(function (n) {
              return Screeps_Constants.part_carry;
          })(Data_Array.range(0)(numberOtherParts - 1 | 0));
          var allParts = Data_Array.concat([ workParts, moveParts, carryParts ]);
          return Control_Bind.bind(Effect.bindEffect)(CreepRoles.spawnCreep(spawn)(allParts)(Data_Maybe.Nothing.value)(new CreepRoles.LDHarvesterMemory({
              role: CreepRoles.LDHarvesterRole.value,
              home: "\"W2N2\"",
              targetRoom: "\"W2N1\""
  ...
  var spawnCreepIfNeeded = function (spawn) {
      return function __do() {
          ...
          var ldHarvesters = Data_Array.mapMaybe(function (v2) {
              if (v2 instanceof Data_Either.Right && v2.value0 instanceof CreepRoles.LDHarvester) {
                  return new Data_Maybe.Just(v2.value0.value0);
              };
              return Data_Maybe.Nothing.value;
          })(creepsAndRoles);
          ...
          var canCreate = Screeps_Spawn.canCreateCreep(spawn)([ Screeps_Constants.part_work, Screeps_Constants.part_work, Screeps_Constants.part_carry, Screeps_Constants.part_move ]);
          ...
          var $23 = Data_Eq.eq(Screeps_Types.eqReturnCode)(canCreate)(Screeps_Constants.ok);
          if ($23) {
              var v2 = Screeps_Spawn.spawning(spawn);
              if (v2 instanceof Data_Maybe.Nothing) {
                  var $25 = Data_Array.length(harvesters) < 2 && maxEnergy >= Screeps_Room.energyAvailable(Screeps_RoomObject.room(spawn));
                  if ($25) {
                  ...
                  var $26 = Data_Array.length(builders) < 3 && maxEnergy >= Screeps_Room.energyAvailable(Screeps_RoomObject.room(spawn));
                  if ($26) {
                  ...
                  var $27 = Data_Array.length(upgraders) < 1 && maxEnergy >= Screeps_Room.energyAvailable(Screeps_RoomObject.room(spawn));
                  if ($27) {
                  ...
                  var $28 = Data_Array.length(ldHarvesters) < 3 && maxEnergy >= Screeps_Room.energyAvailable(Screeps_RoomObject.room(spawn));
                  if ($28) {
                      return createLDHarvesterForAdjacentRoom(spawn)(maxEnergy)();
                  };
              ...
              throw new Error("Failed pattern match at CreepSpawning (line 53, column 9 - line 69, column 22): " + [ v2.constructor.name ]);
          };
          return Data_Unit.unit;
      };
  };
...
(function($PS) {
  "use strict";
  $PS["Role.LDHarvester"] = $PS["Role.LDHarvester"] || {};
  var exports = $PS["Role.LDHarvester"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Data_Array = $PS["Data.Array"];
  var Data_Either = $PS["Data.Either"];
  var Data_Eq = $PS["Data.Eq"];
  ...
  var desiredTarget = function (struct) {
      ...
      if (v instanceof Data_Maybe.Nothing) {
          ...
          if (v1 instanceof Data_Maybe.Nothing) {
              ...
              throw new Error("Failed pattern match at Role.LDHarvester (line 37, column 11 - line 40, column 29): " + [ v2.constructor.name ]);
          };
          throw new Error("Failed pattern match at Role.LDHarvester (line 33, column 7 - line 40, column 29): " + [ v1.constructor.name ]);
      };
      throw new Error("Failed pattern match at Role.LDHarvester (line 29, column 3 - line 40, column 29): " + [ v.constructor.name ]);
  };
  var runLDHarvester = function (v) {
      var atCapacity = Screeps_Creep.amtCarrying(v.creep)(Screeps_Constants.resource_energy) === Screeps_Creep.carryCapacity(v.creep);
      if (atCapacity) {
          var v1 = Screeps_Room.name(Screeps_RoomObject.room(v.creep)) === v.mem.home;
          if (v1) {
              var v2 = Data_Array.head(Data_Array.filter(desiredTarget)(Screeps_Room.find(Screeps_RoomObject.room(v.creep))(Screeps_Constants.find_my_structures)));
              if (v2 instanceof Data_Maybe.Nothing) {
                  return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
              ...
              throw new Error("Failed pattern match at Role.LDHarvester (line 51, column 13 - line 57, column 31): " + [ v2.constructor.name ]);
          };
          if (!v1) {
              var maybeExit = Screeps_Room.findExitTo(Screeps_RoomObject.room(v.creep))(new Screeps_Room.RoomName(v.mem.home));
              if (maybeExit instanceof Data_Either.Left) {
                  return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
              };
              if (maybeExit instanceof Data_Either.Right) {
                  return function __do() {
                      var v2 = Screeps_RoomPosition.findClosestByRange(Screeps_RoomObject.pos(v.creep))(new Screeps_Types.OfType(maybeExit.value0))();
                      if (v2 instanceof Data_Either.Right && v2.value0 instanceof Data_Maybe.Just) {
                          return ignoreM(Effect.monadEffect)(Screeps_Creep.moveTo(v.creep)(new Screeps_Types.TargetPos(v2.value0.value0)))();
                      };
                      return Data_Unit.unit;
                  };
              };
              throw new Error("Failed pattern match at Role.LDHarvester (line 60, column 13 - line 68, column 35): " + [ maybeExit.constructor.name ]);
          };
          throw new Error("Failed pattern match at Role.LDHarvester (line 49, column 9 - line 68, column 35): " + [ v1.constructor.name ]);
      };
      if (!atCapacity) {
          var v1 = v.mem.targetRoom === Screeps_Room.name(Screeps_RoomObject.room(v.creep));
          if (v1) {
              var v2 = Data_Array.head(Screeps_Room.find(Screeps_RoomObject.room(v.creep))(Screeps_Constants.find_sources));
              if (v2 instanceof Data_Maybe.Nothing) {
                  return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
              ...
              if (v2 instanceof Data_Maybe.Just) {
                  return function __do() {
                      var v3 = Screeps_Creep.harvestSource(v.creep)(v2.value0)();
                      var $37 = Data_Eq.eq(Screeps_Types.eqReturnCode)(v3)(Screeps_Constants.err_not_in_range);
                      if ($37) {
                          return ignoreM(Effect.monadEffect)(Screeps_Creep.moveTo(v.creep)(new Screeps_Types.TargetObj(v2.value0)))();
                      };
                      return Data_Unit.unit;
              ...
              throw new Error("Failed pattern match at Role.LDHarvester (line 72, column 13 - line 78, column 31): " + [ v2.constructor.name ]);
          };
          if (!v1) {
              var maybeExit = Screeps_Room.findExitTo(Screeps_RoomObject.room(v.creep))(new Screeps_Room.RoomName(v.mem.targetRoom));
              if (maybeExit instanceof Data_Either.Left) {
                  return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
              };
              if (maybeExit instanceof Data_Either.Right) {
              ...
              throw new Error("Failed pattern match at Role.LDHarvester (line 81, column 15 - line 90, column 32): " + [ maybeExit.constructor.name ]);
          };
          throw new Error("Failed pattern match at Role.LDHarvester (line 70, column 9 - line 90, column 32): " + [ v1.constructor.name ]);
      };
      throw new Error("Failed pattern match at Role.LDHarvester (line 47, column 5 - line 90, column 32): " + [ atCapacity.constructor.name ]);
  };
  exports["runLDHarvester"] = runLDHarvester;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.3
  "use strict";
...
(function($PS) {
  ...
  var Role_LDHarvester = $PS["Role.LDHarvester"];
  ...
  var matchUnit = function (v) {
      ...
      if (v instanceof Data_Either.Right && v.value0 instanceof CreepRoles.LDHarvester) {
          return Role_LDHarvester.runLDHarvester(v.value0.value0);
      };
      if (v instanceof Data_Either.Left) {
          return Effect_Console.log("One of the creeps has a memory I can't parse.\x0a" + v.value0);
      };
      throw new Error("Failed pattern match at Main (line 33, column 1 - line 33, column 68): " + [ v.constructor.name ]);
  };
  ...
  var isTower = function (struct) {
      ...
      throw new Error("Failed pattern match at Main (line 46, column 3 - line 48, column 19): " + [ v.constructor.name ]);
  };
