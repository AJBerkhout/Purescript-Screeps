...
(function($PS) {
  ...
  var hitsMax = Screeps_FFI.unsafeField("hitsMax");
  var hits = Screeps_FFI.unsafeField("hits");
  exports["hits"] = hits;
  exports["hitsMax"] = hitsMax;
...
(function($PS) {
  ...
  var repair = Screeps_FFI.runThisEffFn1("repair");              
...
(function($PS) {
  ...
  var Screeps_Types = $PS["Screeps.Types"];                
  var isEmptyTower = function (struct) {
      var v = Screeps_Tower.toTower(struct);
      if (v instanceof Data_Maybe.Nothing) {
          return false;
      };
      if (v instanceof Data_Maybe.Just) {
          return Screeps_Tower.energy(v.value0) === 0;
      };
      throw new Error("Failed pattern match at Role.Upgrader (line 25, column 3 - line 28, column 20): " + [ v.constructor.name ]);
  };
  var ignore = function (v) {
      return Data_Unit.unit;
  };
  ...
  var runUpgrader = function (v) {
      var emptyTowers = Screeps_Room["find'"](Screeps_RoomObject.room(v.creep))(Screeps_Constants.find_my_structures)(isEmptyTower);
      if (!v.mem.working) {
          var $15 = Screeps_Creep.amtCarrying(v.creep)(Screeps_Constants.resource_energy) < Screeps_Creep.carryCapacity(v.creep);
          if ($15) {
              var v1 = Data_Array.head(Screeps_Room.find(Screeps_RoomObject.room(v.creep))(Screeps_Constants.find_sources));
              if (v1 instanceof Data_Maybe.Nothing) {
                  return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
              ...
              if (v1 instanceof Data_Maybe.Just) {
                  return function __do() {
                      var v2 = Screeps_Creep.harvestSource(v.creep)(v1.value0)();
                      var $18 = Data_Eq.eq(Screeps_Types.eqReturnCode)(v2)(Screeps_Constants.err_not_in_range);
                      if ($18) {
                          return ignoreM(Effect.monadEffect)(Screeps_Creep.moveTo(v.creep)(new Screeps_Types.TargetObj(v1.value0)))();
                      };
                      return Data_Unit.unit;
              ...
              throw new Error("Failed pattern match at Role.Upgrader (line 37, column 9 - line 44, column 27): " + [ v1.constructor.name ]);
          };
          return Screeps_Creep.setMemory(Data_Argonaut_Encode_Class.encodeJsonJBoolean)(v.creep)("working")(true);
      };
      if (v.mem.working) {
          return function __do() {
              var v1 = Screeps_Game.getGameGlobal();
              var $21 = Screeps_Creep.amtCarrying(v.creep)("energy") > 0;
              if ($21) {
                  var v2 = Data_Array.head(emptyTowers);
                  if (v2 instanceof Data_Maybe.Just) {
                      var v3 = Screeps_Creep.transferToStructure(v.creep)(v2.value0)("energy")();
                      var $24 = Data_Eq.eq(Screeps_Types.eqReturnCode)(v3)(Screeps_Constants.err_not_in_range);
                      if ($24) {
                          return ignoreM(Effect.monadEffect)(Screeps_Creep.moveTo(v.creep)(new Screeps_Types.TargetObj(v2.value0)))();
                      };
                      return Data_Unit.unit;
                  ...
                  if (v2 instanceof Data_Maybe.Nothing) {
                      var v3 = Screeps_Room.controller(Screeps_RoomObject.room(v.creep));
                      if (v3 instanceof Data_Maybe.Nothing) {
                          return Data_Unit.unit;
                      };
                      if (v3 instanceof Data_Maybe.Just) {
                          var v4 = Screeps_Creep.upgradeController(v.creep)(v3.value0)();
                          var $28 = Data_Eq.eq(Screeps_Types.eqReturnCode)(v4)(Screeps_Constants.err_not_in_range);
                          if ($28) {
                              return ignoreM(Effect.monadEffect)(Screeps_Creep.moveTo(v.creep)(new Screeps_Types.TargetObj(v3.value0)))();
                          };
                          return Data_Unit.unit;
                      };
                      throw new Error("Failed pattern match at Role.Upgrader (line 59, column 13 - line 68, column 28): " + [ v3.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Role.Upgrader (line 50, column 9 - line 68, column 28): " + [ v2.constructor.name ]);
              };
              return Screeps_Creep.setMemory(Data_Argonaut_Encode_Class.encodeJsonJBoolean)(v.creep)("working")(false)();
          };
      };
      throw new Error("Failed pattern match at Role.Upgrader (line 33, column 3 - line 70, column 40): " + [ v.mem.working.constructor.name ]);
  };
...
(function($PS) {
  ...
  var findClosestByRange$prime = function (pos) {
      return function (ctx) {
          return function (filter) {
              return Effect_Exception["try"](Data_Functor.map(Effect.functorEffect)(Screeps_FFI.toMaybe)(Screeps_FFI.runThisEffFn2("findClosestByRange")(pos)(unwrapContext(ctx))({
                  filter: filter
              })));
          };
      };
  ...
  exports["findClosestByRange'"] = findClosestByRange$prime;
})(PS);
(function($PS) {
  "use strict";
  ...
  var Screeps_Tower = $PS["Screeps.Tower"];
  var Screeps_Types = $PS["Screeps.Types"];                
  var damaged = function (struct) {
      var maxHealth = Screeps_Structure.hitsMax(struct);
      var currentHealth = Screeps_Structure.hits(struct);
      return currentHealth < maxHealth;
  };
  var runTower = function (tower) {
      var roomPos = Screeps_RoomObject.pos(tower);
      return function __do() {
          var v = Screeps_RoomPosition["findClosestByRange'"](roomPos)(new Screeps_Types.OfType(Screeps_Constants.find_my_structures))(damaged)();
          (function () {
              if (v instanceof Data_Either.Left) {
                  return Data_Unit.unit;
              };
              if (v instanceof Data_Either.Right) {
                  if (v.value0 instanceof Data_Maybe.Just) {
                      var v1 = Screeps_Tower.repair(tower)(v.value0.value0)();
                      return Data_Unit.unit;
                  };
                  if (v.value0 instanceof Data_Maybe.Nothing) {
                      return Data_Unit.unit;
                  };
                  throw new Error("Failed pattern match at Screeps.Defense (line 30, column 7 - line 34, column 29): " + [ v.value0.constructor.name ]);
              };
              throw new Error("Failed pattern match at Screeps.Defense (line 27, column 3 - line 34, column 29): " + [ v.constructor.name ]);
          })();
          var v1 = Screeps_RoomPosition.findClosestByRange(roomPos)(new Screeps_Types.OfType(Screeps_Constants.find_hostile_creeps))();
          if (v1 instanceof Data_Either.Left) {
              return Data_Unit.unit;
          };
          if (v1 instanceof Data_Either.Right) {
              if (v1.value0 instanceof Data_Maybe.Just) {
                  var v2 = Screeps_Tower.attack(tower)(v1.value0.value0)();
                  return Data_Unit.unit;
              };
              if (v1.value0 instanceof Data_Maybe.Nothing) {
                  return Data_Unit.unit;
              };
              throw new Error("Failed pattern match at Screeps.Defense (line 39, column 7 - line 44, column 20): " + [ v1.value0.constructor.name ]);
          };
          throw new Error("Failed pattern match at Screeps.Defense (line 36, column 3 - line 44, column 20): " + [ v1.constructor.name ]);
      };
  };
...
(function($PS) {
  ...
  var spawnNewCreeps = function (spawn) {
      return function __do() {
          ...
          var $21 = Data_Array.length(harvesters) < 5;
          if ($21) {
          ...
          var $22 = Data_Array.length(builders) < 2;
          if ($22) {
  ...
  var matchUnit = function (v) {
      ...
      throw new Error("Failed pattern match at Main (line 35, column 1 - line 35, column 68): " + [ v.constructor.name ]);
  };
  ...
  var isTower = function (struct) {
      ...
      throw new Error("Failed pattern match at Main (line 83, column 3 - line 85, column 19): " + [ v.constructor.name ]);
  };
  var loop = function __do() {
      ...
      Data_Foldable.for_(Effect.applicativeEffect)(Foreign_Object.foldableObject)(Screeps_Game.spawns(v))(function (spawn) {
          ...
          return function __do() {
              ...
              var $34 = Data_Eq.eq(Screeps_Types.eqReturnCode)(Screeps_Spawn.canCreateCreep(spawn)([ Screeps_Constants.part_move, Screeps_Constants.part_work, Screeps_Constants.part_work, Screeps_Constants.part_carry ]))(Screeps_Constants.ok);
              if ($34) {
